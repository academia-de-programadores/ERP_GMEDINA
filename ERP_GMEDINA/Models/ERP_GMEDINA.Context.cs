...
namespace ERP_GMEDINA.Models
{
    ...
    public partial class ERP_GMEDINAEntities : DbContext
    {
        ...
        public virtual int UDP_RRHH_tbfasesReclutamiento_Delete(Nullable<int> fare_Id, string fare_razon_Inactivo, Nullable<int> fare_UsuarioModifica, Nullable<System.DateTime> fare_FechaModifica)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("UDP_RRHH_tbfasesReclutamiento_Delete", fare_IdParameter, fare_razon_InactivoParameter, fare_UsuarioModificaParameter, fare_FechaModificaParameter);
        }
