...
function CargarDatos() {
    ...
    var Otros = "";
    //id = (id, 16);
    var validacionPermiso = userModelStateNoTzt("Empleados/CargarArchivos");
...
function CargarDatosExpedienteViejo() {
    ...
    var Otros = "";
    //id = (id, 16);
    var validacionPermiso = userModelStateNoTzt("Empleados/CargarArchivosExpedienteViejo");
    if (validacionPermiso.status == true) {
        _ajax(null,
...
$("#InActivar").click(function () {
    var validacionPermiso = userModelState("Empleados/Delete");
    if (validacionPermiso.status == true) {
...
function ModalDetalles(id) {
    var validacionPermiso = userModelState("Empleados/DetallesExpediente");
    if (validacionPermiso.status == true) {
        _ajax(null,
