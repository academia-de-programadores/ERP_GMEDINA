...
$(document).on("click", "#ParametrosDecimoCuartoMesRPT", function () {
	$("#DecimoCuartoMesModalRPT").modal();
});

// OCULTAR MODAL DE FECHAS
$("#btnCerrarModalRPT").click(function () {
	$("#DecimoCuartoMesModalRPT").modal('hide');
});
...
$("#btnEnviarParametros").click(function () {
	var Parametro1 = $("#dcm_FechaPago").val();
