                                ...
                                using (var dbContextTransaccion = db.Database.BeginTransaction())
                                {
                                    try
                                    {
                                        ...
                                        */
                                        ...
                                        TotalDeduccionesGravables = (Decimal)AcumuladosISR /*+ (Decimal)TotalDeduccionesEquipoTrabajo + (Decimal)TotalDeduccionesExtras + (Decimal)TotalDeduccionesAFP*/;
                                        ...
                                        listHistorialPago = db.UDP_Plani_tbHistorialDePago_Insert(oHistorialPagoEncabezado.emp_Id,
                                                                                                ...
                                                                                                "123" // codigo identificador de la planilla
                                                                                                );
